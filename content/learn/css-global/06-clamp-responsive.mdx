...
<LearnMore>
この2つ以外に、**コンテナクエリ**（`@container`）という方法もあります。<br />
メディアクエリが「画面全体の幅」で切り替えるのに対し、コンテナクエリは「親要素の幅」で切り替えます。

<a href="https://web.dev/learn/css/container-queries?hl=ja" target="_blank" rel="noopener noreferrer">参考: コンテナクエリ</a>
</LearnMore>
...
<div className="lg:hidden">
  <Callout type="info">
  スマホやタブレットでご覧の場合、CSSが正常に反映されない場合があります。
  ぜひ、PCでご確認ください！
  </Callout>
</div>
...
アプリの規模が大きくなるにつれて管理が大変になりますね。<br />
