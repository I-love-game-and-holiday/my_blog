...
システムやサービスにおいてバリデーションは非常に重要です。<br/>
...
正規表現は奥が深いですが、今回は「形式が合っているか」のチェックに使っています。<br/>
...
```
<Callout type="info">
実務では <a href="https://zod.dev/" target="_blank" rel="noopener noreferrer">Zod</a> などの
バリデーションライブラリを使うことが多いです。<br/>
